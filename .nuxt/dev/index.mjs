...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/h3/dist/index.mjs';
import { MongoClient } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/mongodb/lib/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/devalue/index.js';
import destr from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/vue/index.mjs';
import BaseStyle from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/@primevue/core/base/style/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/dekzvj/GitHub/qatools2/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/dekzvj/GitHub/qatools2/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dekzvj/GitHub/qatools2","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dekzvj/GitHub/qatools2/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dekzvj/GitHub/qatools2/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dekzvj/GitHub/qatools2/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/dekzvj/GitHub/qatools2/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _mtg3936sV7 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/dekzvj/GitHub/qatools2";
...
const styles$2 = [
    ,
    BaseStyle && BaseStyle.getStyleSheet ? BaseStyle.getStyleSheet(undefined, styleProps) : '',ToastStyle && ToastStyle.getStyleSheet ? ToastStyle.getStyleSheet(undefined, styleProps) : ''
].join('');
...
[
    ...
    BaseStyle && BaseStyle.getThemeStyleSheet ? BaseStyle.getThemeStyleSheet(undefined, styleProps) : '',ToastStyle && ToastStyle.getThemeStyleSheet ? ToastStyle.getThemeStyleSheet(undefined, styleProps) : ''
].join('');

const defineNitroPlugin = (def) => def;
const _2KXrv0AIqk = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_owAgdC = () => Promise.resolve().then(function () { return storeSelection_post$1; });
const _lazy_pxPxIx = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/storeSelection', handler: _lazy_owAgdC, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_pxPxIx, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_pxPxIx, lazy: true, middleware: false, method: undefined }
];
...
const storeSelection_post = defineEventHandler(async (event) => {
...
const storeSelection_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: storeSelection_post
});
...
const getClientManifest = () => import('file:///Users/dekzvj/GitHub/qatools2/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/dekzvj/GitHub/qatools2/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
